...
urlpatterns = [
    ...
    # Form Builder pages
    path('form-builder/', views.form_builder_index, name='admin_form_builder_index'),
    path('form-builder/section/<slug:section_key>/', views.form_builder_section, name='admin_form_builder_section'),

    # Tab/Section AJAX
    path('form-builder/api/tab/<int:pk>/update/', views.api_update_tab, name='admin_api_tab_update'),
    path('form-builder/api/section/<int:pk>/update/', views.api_update_section, name='admin_api_section_update'),

    # Category AJAX
    path('form-builder/api/category/create/', views.api_create_category, name='admin_api_category_create'),
    path('form-builder/api/category/<int:pk>/update/', views.api_update_category, name='admin_api_category_update'),
    path('form-builder/api/category/<int:pk>/delete/', views.api_delete_category, name='admin_api_category_delete'),

    # Option AJAX
    path('form-builder/api/option/create/', views.api_create_option, name='admin_api_option_create'),
    path('form-builder/api/option/<int:pk>/update/', views.api_update_option, name='admin_api_option_update'),
    path('form-builder/api/option/<int:pk>/delete/', views.api_delete_option, name='admin_api_option_delete'),
]